...
KEY = "RGAPI-94c3df7b-0441-4943-a51a-b3a48f9d1df7"
...
def predictChampionsWithData(bans_input,blue_input,red_input,roles_input,team_input,position_input,pseudo_input,X,L,KEY):
    #Fonction de test (la vraie fonction en en-dessous)
    t0 = time()
    if team_input:
        ally = blue_input
        enemy = red_input
